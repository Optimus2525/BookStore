...
values ('Learning Spring Boot 2.0', 'Craig Walls', '862314',
        'The book further explores advanced concepts — like the Spring Boot Actuator — to find out what’s going on inside a Spring Boot application.',
        253)
     ...
     , ('Cloud-Native Java', 'Craig Walls', '321456',
        'In the beginning, cloud terminologies, and services may seem overwhelming, but if you stick around and finish the book.',
        253)
     ...
     , ('Mastering Spring Boot 2.0', 'Dinesh Rajput', '357951',
        'Once you are familiar with the basics, you will explore advanced things like customizing auto-configuration to meet your expectation.',
        753)
;
